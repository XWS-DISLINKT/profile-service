...
func mapToDomain(profilePb *pb.Profile) *domain.Profile {
	profile := &domain.Profile{
		...
		ReceivesConnectionNotifications: profilePb.ReceivesConnectionNotifications,
		ReceivesMessageNotifications:    profilePb.ReceivesMessageNotifications,
		ReceivesPostNotifications:       profilePb.ReceivesPostNotifications,
		IsAdmin:                         profilePb.IsAdmin,
	}
